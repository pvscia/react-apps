export default function Hero() {
    ...
    return (
        <>
            <h1>Coffe Tracking for Coffee <abbr title="An enthusiast Devotee">Fiends</abbr></h1>
            <div className="benefits-list">
                <h3 className="font-bold">Try <span className="text-gradient">Caffiends</span> and start ...</h3>
