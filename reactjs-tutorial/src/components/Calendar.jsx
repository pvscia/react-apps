...
export default function Calendar(props) {
    ...
    console.log(yearsArr, yearsArr.length, Array(lifeExpectancy))
        ...
        <section>
            ...
            <div className="dozen-grid">
                {yearsArr.map((year, yearIndex) => {
                    return (<DozenDisplay key={yearIndex} weekNum={weekNum} weeksArr={weeksArr} yearIndex={yearIndex} finalWeek={finalWeek} />)
                })}
            </div>
        </section>
    )
